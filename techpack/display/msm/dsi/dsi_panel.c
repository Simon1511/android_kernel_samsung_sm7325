...
{
	struct samsung_display_driver_data *vdd = (struct samsung_display_driver_data *)panel->panel_private;

	vdd->br_info.common_br.finger_mask_bl_level = status ? 331 : 0;

	vdd->finger_mask = status;
